...
if(message.author.id !== '500212672688685056') return message.channel.send('❎ » هذا الأمر مخصص لصاحب البوت فقط');
...
if (message.content.startsWith('!Mhstr')){
 if (message.author.id !== '507978288250093568') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
...
const embed = new Discord.RichEmbed()
   .setColor("RANDOM")
   .addField("『Neptune System』 『اسم البوت』", true)

   .addField("『-help-all』😘『اذا تبي جميع الاوامر مع اوامر اضافية』😵", true)
   
   .addField("『-help-public』👻『اذا تبي الاوامر العامة』😳", true)
     
   .addField("『-help-admin』😮『اذا تبي  الاوامر الادارية』🤒", true)
...
client.on('guildMemberAdd', member => {
    let channel = member.guild.channels.find('name', 'neptune');
